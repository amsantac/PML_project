...
I selected the randomForests with PCA preprocessing model as the best one given its high accuracy when evaluated on the test datasets. The out of sample error is estimated to be about 29%.
